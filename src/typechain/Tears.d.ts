...
interface TearsInterface extends ethers.utils.Interface {
  functions: {
    ...
    "lp(address)": FunctionFragment;
    "name()": FunctionFragment;
    "owner()": FunctionFragment;
    "renounceOwnership()": FunctionFragment;
    "setLP(address,bool)": FunctionFragment;
  ...
  encodeFunctionData(functionFragment: "lp", values: [string]): string;
...
export class Tears extends BaseContract {
  ...
  functions: {
    ...
    lp(arg0: string, overrides?: CallOverrides): Promise<[boolean]>;
  ...
  estimateGas: {
    ...
    lp(arg0: string, overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    lp(arg0: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
